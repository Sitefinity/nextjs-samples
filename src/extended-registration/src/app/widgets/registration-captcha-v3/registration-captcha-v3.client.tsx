...
export function RegistrationCaptchaV3Client(props: RegistrationFormProps) {
                ...
                submitBtn.addEventListener('click', function (event) {
                    if (!isSubmit) {
                        ...
                        (window as any).grecaptcha.ready(function () {
                            (window as any).grecaptcha.execute(siteKey, { action: 'submit' }).then(function (response: string) {
    ...
    return (<>
      <Script
        src={'https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=' + siteKey}
        strategy={'lazyOnload'}
      />
