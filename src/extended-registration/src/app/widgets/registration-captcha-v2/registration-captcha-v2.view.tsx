...
import { RegistrationCaptchaV2Client } from './registration-captcha-v2.client';
...
export function RegistrationCaptchaV2View(props: RegistrationViewProps<RegistrationEntity>) {
