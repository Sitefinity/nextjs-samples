...
export interface PARAGAnswerStaticConfig {
    id: string;
    display: {
        mode: string;
        containerId: string;
...
export function PARAGAnswerDefaultView(props: PARAGAnswerViewProps) {
    ...
    const staticConfig: PARAGAnswerStaticConfig = {
        id: 'sf-answer-box',
        display: {
            mode: 'answer',
          ...
          <div className="sf-assistant-header">
            ...
            <div className="sf-message-actions">
              ...
              <div className="sf-feedback-buttons">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="20" height="20">
